...
const Chatbot = ({ isOpen, closeChat }) => {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      <div className="fixed bottom-4 right-4 w-full md:w-[380px] h-[500px] bg-dark-gray z-50 shadow-xl rounded-xl overflow-hidden flex flex-col max-w-[calc(100vw-2rem)]">
        {/* Chat header */}
        <div className="px-4 py-3 bg-gradient-to-r from-accent to-accent-light flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-white">CuratedCrafts Assistant</h3>
